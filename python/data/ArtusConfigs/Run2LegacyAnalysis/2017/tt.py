...
def build_config(nickname, **kwargs):
  ...
  if isEmbedded:
    config["EmbeddingFakeMETCorrection"] = "(x-y)*0.935 + y*(1.+-0.002)"
  ...
  if isEmbedded:
    ...
    config["EmbeddedWeightWorkspace"] = "$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/data/root/scaleFactorWeights/htt_scalefactors_legacy_trimmed_2017.root"
