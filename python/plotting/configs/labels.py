...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["emb"] = "Z/t#bar{t}/diboson (#tau#tau)"
			self.labels_dict["elemb"] = "#mu #rightarrow e embedded"
			...
			self.labels_dict["ttl"] = "t#bar{t} (l#tau)"
			...
			self.labels_dict["st"] = "Single top"
			self.labels_dict["vvj"] = "Diboson (jet#rightarrow#tau_{h})"
			self.labels_dict["ewkN"] = ""
			self.labels_dict["ewkn"] = ""
			...
			self.labels_dict["h3"] = "H(1000) #rightarrow h1(500)h0(125) #rightarrow #tau#tau b#bar{b} (0.2 pb)"
			...
			self.labels_dict["diLepMass"] = "m_{vis} (GeV)"
			...
			self.labels_dict["tt_m_ll"] = "m_{vis} (GeV)"
			self.labels_dict["tt_m_llmet"] = "m_{\\ell\\ell,MEt} (GeV)"
			self.labels_dict["tt_m_sv"] = "m_{SV-Fit} (GeV)"
			self.labels_dict["tt_m_sv_puppi"] = "m_{#tau#tau}^{SVFit} (GeV)"
			self.labels_dict["tt_met"] = "p_{T}^{miss}"
			...
			self.labels_dict["tt_metphi"] = "p_{T}^{miss} #phi"
			self.labels_dict["tt_mjj"] = "m_{jj} (GeV)"
                        self.labels_dict["tt_dijetpt"] = "p_{T}(jj) (GeV)"
			self.labels_dict["tt_diBJetPt"] = "p_{T}(b#bar{b}) (GeV)"
			self.labels_dict["tt_diBJetMass"] = "m_{b#bar{b}} (GeV)"
			self.labels_dict["tt_pt_bb"] = "p_{T}(b#bar{b}) (GeV)"
			self.labels_dict["tt_mbb"] = "m_{b#bar{b}} (GeV)"
			self.labels_dict["tt_m_ttbb"] = "m_{#tau#tau(+MET)bb} (PF) (GeV)"
			self.labels_dict["tt_m_ttbb_puppi"] = "m_{#tau#tau(+MET)bb} (Puppi) (GeV)"
			self.labels_dict["tt_m_ttvisbb"] = "m_{#tau#tau(vis)bb} (GeV)"
			self.labels_dict["tt_pt_bb_1btag"] = "p_{T}(b+jet) (GeV)"
			self.labels_dict["tt_mbb_1btag"] = "m_{b+jet} (GeV)"
			self.labels_dict["tt_m_ttbb_1btag"] = "m_{#tau#tau(+MET)b+jet} (PF) (GeV)"
			self.labels_dict["tt_m_ttbb_puppi_1btag"] = "m_{#tau#tau(+MET)b+jet} (Puppi) (GeV)"
			self.labels_dict["tt_m_ttvisbb_1btag"] = "m_{#tau#tau(vis)b+jet} (GeV)"
                        self.labels_dict["tt_bcsv_1"] = "Leading b-jet CSV score"
                        self.labels_dict["tt_bcsv_2"] = "Trailing b-jet CSV score"
                        self.labels_dict["tt_highCSVjetUsedFordiBJetSystemCSV"] = "Max. CSV score of non-b-jet jets"
                        self.labels_dict["tt_bm_bReg_1"] = "Leading b-jet mass (GeV)"
                        self.labels_dict["tt_bm_bReg_2"] = "Trailing b-jet mass (GeV)"
                        self.labels_dict["tt_bpt_bReg_1"] = "Leading b-jet p_{T} (GeV)"
                        self.labels_dict["tt_bpt_bReg_2"] = "Trailing b-jet p_{T} (GeV)"
			self.labels_dict["tt_mbb_highCSV_bReg"] = "m_{b#bar{b}} (GeV)"
                        self.labels_dict["tt_pt_bb_highCSV_bReg"] = "Di-b-jet p_{T} (GeV)"
			self.labels_dict["tt_m_ttvisbb_highCSV_bReg"] = "m_{#tau#tau(vis)bb} (GeV)"
                        self.labels_dict["tt_pt_ttvisbb_highCSV_bReg"] = "p_{T}(#tau#tau(vis)bb) (GeV)"
			self.labels_dict["tt_kinfit_chi2"] = "KinFit #chi^{2}"
                        self.labels_dict["tt_kinfit_mh2"] = "KinFit selected m_{h'} (GeV)"
                        self.labels_dict["tt_kinfit_mH"] = "m_{H}^{KinFit} (GeV)"


			self.labels_dict["tt_mt_1"] = "m_{T}^{#tau_{h}} (GeV)"
			self.labels_dict["tt_mt_1_puppi"] = "m_{T}^{#tau_{h}} (Puppi) (GeV)"
			self.labels_dict["tt_mt_tot"] = "Total Transverse Mass m^{tot}_{T} (GeV)"
			self.labels_dict["tt_mt_lep1met"] = "m_{T}^{#tau_{h}} (GeV)"
			...
			self.labels_dict["tt_m_vis"] = "m_{vis} (GeV)"
			self.labels_dict["tt_m_N"] = "Nostradamass m^{NN}_{#tau#tau} (GeV)"
			self.labels_dict["tt_nJets30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["tt_njetspt30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["tt_njets"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["tt_nbtag"] = "N_{b jet} (p_{T}^{jet} > 20 GeV)"
			self.labels_dict["tt_njetingap"] = "Number of central Jets"
			self.labels_dict["tt_npu"] = "NPU"
			self.labels_dict["tt_npv"] = "N_{vtx}"
			...
			self.labels_dict["tt_pt_1"] = "Leading #tau_{h} p_{T} (GeV)"
			...
			self.labels_dict["tt_pZetaMissVis"] = "D_{#zeta} (GeV)"
			...
			self.labels_dict["mt_jpt_1"] = "Leading p_{T}^{jet} (GeV)"
			self.labels_dict["mt_jpt_2"] = "Trailing p_{T}^{jet} (GeV)"
			self.labels_dict["mt_m_1"] = "Muon Mass (GeV)"
			self.labels_dict["mt_m_2"] = "Tau Mass (GeV)"
			self.labels_dict["mt_m_ll"] = "m_{vis} (GeV)"
			self.labels_dict["mt_m_llmet"] = "m_{\\ell\\ell,MEt} (GeV)"
			self.labels_dict["mt_m_sv"] = "m_{SV-Fit} (GeV)"
			self.labels_dict["mt_m_sv_puppi"] = "m_{#tau#tau} (GeV)"
			self.labels_dict["mt_met"] = "p_{T}^{miss} (GeV)"
			...
			self.labels_dict["mt_metphi"] = "p_{T}^{miss} #phi"
			self.labels_dict["mt_mjj"] = "m_{jj} (GeV)"
                        self.labels_dict["mt_dijetpt"] = "p_{T}(jj) (GeV)"
			self.labels_dict["mt_diBJetPt"] = "p_{T}(b#bar{b}) (GeV)"
			self.labels_dict["mt_diBJetMass"] = "m_{b#bar{b}} (GeV)"
			self.labels_dict["mt_pt_bb"] = "p_{T}(b#bar{b}) (GeV)"
			self.labels_dict["mt_mbb"] = "m_{b#bar{b}} (GeV)"
			self.labels_dict["mt_m_ttbb"] = "m_{#tau#tau(+MET)bb} (PF) (GeV)"
			self.labels_dict["mt_m_ttbb_puppi"] = "m_{#tau#tau(+MET)bb} (Puppi) (GeV)"
			self.labels_dict["mt_m_ttvisbb"] = "m_{#tau#tau(vis)bb} (GeV)"
			self.labels_dict["mt_pt_bb_1btag"] = "p_{T}(b+jet) (GeV)"
			self.labels_dict["mt_mbb_1btag"] = "m_{b+jet} (GeV)"
			self.labels_dict["mt_m_ttbb_1btag"] = "m_{#tau#tau(+MET)b+jet} (PF) (GeV)"
			self.labels_dict["mt_m_ttbb_puppi_1btag"] = "m_{#tau#tau(+MET)b+jet} (Puppi) (GeV)"
			self.labels_dict["mt_m_ttvisbb_1btag"] = "m_{#tau#tau(vis)b+jet} (GeV)"
                        self.labels_dict["mt_bcsv_1"] = "Leading b-jet CSV score"
                        self.labels_dict["mt_bcsv_2"] = "Trailing b-jet CSV score"
                        self.labels_dict["mt_highCSVjetUsedFordiBJetSystemCSV"] = "Max. CSV score of non-b-jet jets"
                        self.labels_dict["mt_bm_bReg_1"] = "Leading b-jet mass (GeV)"
                        self.labels_dict["mt_bm_bReg_2"] = "Trailing b-jet mass (GeV)"
                        self.labels_dict["mt_bpt_bReg_1"] = "Leading b-jet p_{T} (GeV)"
                        self.labels_dict["mt_bpt_bReg_2"] = "Trailing b-jet p_{T} (GeV)"
                        self.labels_dict["mt_mbb_highCSV_bReg"] = "m_{bb} (GeV)"
                        self.labels_dict["mt_pt_bb_highCSV_bReg"] = "Di-b-jet p_{T} (GeV)"
                        self.labels_dict["mt_m_ttvisbb_highCSV_bReg"] = "m^{vis}_{#tau#taubb} (GeV)"
                        self.labels_dict["mt_pt_ttvisbb_highCSV_bReg"] = "p_{T}(#tau#tau(vis)bb) (GeV)"
                        self.labels_dict["mt_kinfit_chi2"] = "KinFit #chi^{2}"
                        self.labels_dict["mt_kinfit_mh2"] = "m^{Kin. fit}_{h_{S}} (GeV)"
                        self.labels_dict["mt_kinfit_mH"] = "m_{H}^{Kin. fit} (GeV)"



			self.labels_dict["mt_mt_1"] = "m_{T}^{#mu} (GeV)"
			self.labels_dict["mt_mt_1_puppi"] = "m_{T}^{#mu} (Puppi) (GeV)"
			self.labels_dict["mt_mt_2"] = "m_{T}^{#tau_{h}} (GeV)"
			self.labels_dict["mt_mt_tot"] = "Total Transverse Mass m^{tot}_{T} (GeV)"
			self.labels_dict["mt_mt_lep1met"] = "m_{T}^{#mu} (GeV)"
			...
			self.labels_dict["mt_m_vis"] = "m_{vis} (GeV)"
			self.labels_dict["mt_m_N"] = "Nostradamass m^{NN}_{#tau#tau} (GeV)"
			self.labels_dict["mt_nJets30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["mt_njetspt30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["mt_njets"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["mt_nbtag"] = "N_{b jet} (p_{T}^{jet} > 20 GeV)"
			self.labels_dict["mt_njetingap"] = "Number of central Jets"
			self.labels_dict["mt_npu"] = "NPU"
			self.labels_dict["mt_npv"] = "N_{vtx}"
			...
			self.labels_dict["mt_pZetaMissVis"] = "D_{#zeta} (GeV)"
			...
			self.labels_dict["et_m_ll"] = "m_{vis} (GeV)"
			self.labels_dict["et_m_llmet"] = "m_{\\ell\\ell,MEt} (GeV)"
			self.labels_dict["et_m_sv"] = "m_{SV-Fit} (GeV)"
			self.labels_dict["et_m_sv_puppi"] = "m_{#tau#tau}^{SVFit} (GeV)"
			self.labels_dict["et_met"] = "p_{T}^{miss}"
			...
			self.labels_dict["et_metphi"] = "p_{T}^{miss} #phi"
			self.labels_dict["et_mjj"] = "m_{jj} (GeV)"
                        self.labels_dict["et_dijetpt"] = "p_{T}(jj) (GeV)"
			self.labels_dict["et_diBJetPt"] = "p_{T}(b#bar{b}) (GeV)"
			self.labels_dict["et_diBJetMass"] = "m_{b#bar{b}} (GeV)"
			self.labels_dict["et_pt_bb"] = "p_{T}(b#bar{b}) (GeV)"
			self.labels_dict["et_mbb"] = "m_{b#bar{b}} (GeV)"
			self.labels_dict["et_m_ttbb"] = "m_{#tau#tau(+MET)bb} (PF) (GeV)"
			self.labels_dict["et_m_ttbb_puppi"] = "m_{#tau#tau(+MET)bb} (Puppi) (GeV)"
			self.labels_dict["et_m_ttvisbb"] = "m_{#tau#tau(vis)bb} (GeV)"
			self.labels_dict["et_pt_bb_1btag"] = "p_{T}(b+jet) (GeV)"
			self.labels_dict["et_mbb_1btag"] = "m_{b+jet} (GeV)"
			self.labels_dict["et_m_ttbb_1btag"] = "m_{#tau#tau(+MET)b+jet} (PF) (GeV)"
			self.labels_dict["et_m_ttbb_puppi_1btag"] = "m_{#tau#tau(+MET)b+jet} (Puppi) (GeV)"
			self.labels_dict["et_m_ttvisbb_1btag"] = "m_{#tau#tau(vis)b+jet} (GeV)"
                        self.labels_dict["et_bcsv_1"] = "Leading b-jet CSV score"
                        self.labels_dict["et_bcsv_2"] = "Trailing b-jet CSV score"
                        self.labels_dict["et_highCSVjetUsedFordiBJetSystemCSV"] = "Max. CSV score of non-b-jet jets"
                        self.labels_dict["et_bm_bReg_1"] = "Leading b-jet mass (GeV)"
                        self.labels_dict["et_bm_bReg_2"] = "Trailing b-jet mass (GeV)"
                        self.labels_dict["et_bpt_bReg_1"] = "Leading b-jet p_{T} (GeV)"
                        self.labels_dict["et_bpt_bReg_2"] = "Trailing b-jet p_{T} (GeV)"
                        self.labels_dict["et_mbb_highCSV_bReg"] = "m_{b#bar{b}} (GeV)"
                        self.labels_dict["et_pt_bb_highCSV_bReg"] = "Di-b-jet p_{T} (GeV)"
                        self.labels_dict["et_m_ttvisbb_highCSV_bReg"] = "m_{#tau#tau(vis)bb} (GeV)"
                        self.labels_dict["et_pt_ttvisbb_highCSV_bReg"] = "p_{T}(#tau#tau(vis)bb) (GeV)"
                        self.labels_dict["et_kinfit_chi2"] = "KinFit #chi^{2}"
                        self.labels_dict["et_kinfit_mh2"] = "KinFit selected m_{h'} (GeV)"
                        self.labels_dict["et_kinfit_mH"] = "m_{H}^{KinFit} (GeV)"



			self.labels_dict["et_mt_1"] = "m_{T}^{e} (GeV)"
			self.labels_dict["et_mt_1_puppi"] = "m_{T}^{e} (Puppi) (GeV)"
			self.labels_dict["et_mt_tot"] = "Total Transverse Mass m^{tot}_{T} (GeV)"
			self.labels_dict["et_mt_lep1met"] = "m_{T}^{e} (GeV)"
			...
			self.labels_dict["et_m_vis"] = "m_{vis} (GeV)"
			self.labels_dict["et_m_N"] = "Nostradamass m^{NN}_{#tau#tau} (GeV)"
			self.labels_dict["et_nJets30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["et_njetspt30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["et_njets"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["et_nbtag"] = "N_{b jet} (p_{T}^{jet} > 20 GeV)"
			self.labels_dict["et_njetingap"] = "Number of central Jets"
			self.labels_dict["et_npu"] = "NPU"#Delta R(ll,jj)
			self.labels_dict["et_npv"] = "N_{vtx}"
			...
			self.labels_dict["et_pZetaMissVis"] = "D_{#zeta} (GeV)"
			...
			self.labels_dict["em_m_ll"] = "m_{vis} (GeV)"
			self.labels_dict["em_m_llmet"] = "m_{\\ell\\ell,MEt} (GeV)"
			self.labels_dict["em_m_sv"] = "Di-#tau Mass m_{#tau#tau} (GeV)"
			self.labels_dict["em_m_sv_puppi"] = "m_{SV-Fit} (GeV)"
			self.labels_dict["em_met"] = "p_{T}^{miss}"
			...
			self.labels_dict["em_metphi"] = "p_{T}^{miss} #phi"
			self.labels_dict["em_mjj"] = "m_{jj} (GeV)"
                        self.labels_dict["em_dijetpt"] = "p_{T}(jj) (GeV)"
			self.labels_dict["em_diBJetPt"] = "p_{T}(b#bar{b}) (GeV)"
			self.labels_dict["em_diBJetMass"] = "m_{b#bar{b}} (GeV)"
			self.labels_dict["em_pt_bb"] = "p_{T}(b#bar{b}) (GeV)"
			self.labels_dict["em_mbb"] = "m_{b#bar{b}} (GeV)"
			self.labels_dict["em_m_ttbb"] = "m_{#tau#tau(+MET)bb} (PF) (GeV)"
			self.labels_dict["em_m_ttbb_puppi"] = "m_{#tau#tau(+MET)bb} (Puppi) (GeV)"
			self.labels_dict["em_m_ttvisbb"] = "m_{#tau#tau(vis)bb} (GeV)"
			self.labels_dict["em_pt_bb_1btag"] = "p_{T}(b+jet) (GeV)"
			self.labels_dict["em_mbb_1btag"] = "m_{b+jet} (GeV)"
			self.labels_dict["em_m_ttbb_1btag"] = "m_{#tau#tau(+MET)b+jet} (PF) (GeV)"
			self.labels_dict["em_m_ttbb_puppi_1btag"] = "m_{#tau#tau(+MET)b+jet} (Puppi) (GeV)"
			self.labels_dict["em_m_ttvisbb_1btag"] = "m_{#tau#tau(vis)b+jet} (GeV)"
                        self.labels_dict["em_bcsv_1"] = "Leading b-jet CSV score"
                        self.labels_dict["em_bcsv_2"] = "Trailing b-jet CSV score"
                        self.labels_dict["em_highCSVjetUsedFordiBJetSystemCSV"] = "Max. CSV score of non-b-jet jets"
                        self.labels_dict["em_bm_bReg_1"] = "Leading b-jet mass (GeV)"
                        self.labels_dict["em_bm_bReg_2"] = "Trailing b-jet mass (GeV)"
                        self.labels_dict["em_bpt_bReg_1"] = "Leading b-jet p_{T} (GeV)"
                        self.labels_dict["em_bpt_bReg_2"] = "Trailing b-jet p_{T} (GeV)"
                        self.labels_dict["em_mbb_highCSV_bReg"] = "m_{b#bar{b}} (GeV)"
                        self.labels_dict["em_pt_bb_highCSV_bReg"] = "Di-b-jet p_{T} (GeV)"
                        self.labels_dict["em_m_ttvisbb_highCSV_bReg"] = "m_{#tau#tau(vis)bb} (GeV)"
                        self.labels_dict["em_pt_ttvisbb_highCSV_bReg"] = "p_{T}(#tau#tau(vis)bb) (GeV)"
                        self.labels_dict["em_kinfit_chi2"] = "KinFit #chi^{2}"
                        self.labels_dict["em_kinfit_mh2"] = "KinFit selected m_{h'} (GeV)"
                        self.labels_dict["em_kinfit_mH"] = "m_{H}^{KinFit} (GeV)"



			self.labels_dict["em_mt_1"] = "m_{T}^{e} (GeV)"
			self.labels_dict["em_mt_1_puppi"] = "m_{T}^{e} (Puppi) (GeV)"
			self.labels_dict["em_mt_tot"] = "Total Transverse Mass m^{tot}_{T} (GeV)"
			self.labels_dict["em_mt_lep1met"] = "m_{T}^{e} (GeV)"
			...
			self.labels_dict["em_m_vis"] = "m_{vis} (GeV)"
			self.labels_dict["em_m_N"] = "Nostradamass m^{NN}_{#tau#tau} (GeV)"
			self.labels_dict["em_nJets30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["em_njetspt30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["em_njets"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["em_nbtag"] = "N_{b jet} (p_{T}^{jet} > 20 GeV)"
			self.labels_dict["em_njetingap"] = "Number of central Jets"
			self.labels_dict["em_npu"] = "NPU"
			self.labels_dict["em_npv"] = "N_{vtx}"
			...
			self.labels_dict["em_pZetaMissVis"] = "D_{#zeta} (GeV)"
			...
			self.labels_dict["mm_met"] = "p_{T}^{miss}"
			...
			self.labels_dict["mm_metphi"] = "p_{T}^{miss} #phi"
			self.labels_dict["mm_mjj"] = "m_{jj} (GeV)"
			self.labels_dict["mm_mt_1"] = "m_{T}^{#mu} (GeV)"
			self.labels_dict["mm_mt_lep1met"] = "m_{T}^{#mu} (GeV)"
			...
			self.labels_dict["mm_nJets30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["mm_njetspt30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["mm_njets"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["mm_nbtag"] = "N_{b jet} (p_{T}^{jet} > 20 GeV)"
			self.labels_dict["mm_njetingap"] = "Number of central Jets"
			self.labels_dict["mm_npu"] = "NPU"
			self.labels_dict["mm_npv"] = "N_{vtx}"
			...
			self.labels_dict["ee_met"] = "p_{T}^{miss}"
			...
			self.labels_dict["ee_metphi"] = "p_{T}^{miss} #phi"
			self.labels_dict["ee_mjj"] = "m_{jj} (GeV)"
			self.labels_dict["ee_mt_1"] = "m_{T}^{e} (GeV)"
			self.labels_dict["ee_mt_lep1met"] = "m_{T}^{e} (GeV)"
			...
			self.labels_dict["ee_nJets30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["ee_njetspt30"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["ee_njets"] = "N_{jet} (p_{T}^{jet} > 30 GeV)"
			self.labels_dict["ee_nbtag"] = "N_{b jet} (p_{T}^{jet} > 20 GeV)"
			self.labels_dict["ee_njetingap"] = "Number of central Jets"
			self.labels_dict["ee_npu"] = "NPU"
			self.labels_dict["ee_npv"] = "N_{vtx}"
			...
			self.labels_dict["ee_visibleOverFullEnergy_2"] = "Trailing Electron E(e) / E_{#tau}"
                        ...
                        self.labels_dict["em_nnscore"] = "NN Score"
                        self.labels_dict["et_nnscore"] = "NN Score"
                        self.labels_dict["mt_nnscore"] = "NN Score"
                        self.labels_dict["tt_nnscore"] = "NN Score"
			...
			for ch in ["ee_", "em_", "et_", "mm_", "mt_", "tt_"]:
				...
				self.labels_dict[ch+"vbf_vs_ztt"] = "BDT_{Z#rightarrow#tau#tau}^{vbf}"
                                ...
                                self.labels_dict[ch+"max_score"] = "NN Score"
			...
			self.labels_dict["tt_jpt_1"] = "$\\mathrm{Leading} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			self.labels_dict["tt_jpt_2"] = "$\\mathrm{Trailing} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			...
			self.labels_dict["mt_jpt_1"] = "$\\mathrm{Leading} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			self.labels_dict["mt_jpt_2"] = "$\\mathrm{Trailing} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			...
			self.labels_dict["et_jpt_1"] = "$\\mathrm{Leading} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			self.labels_dict["et_jpt_2"] = "$\\mathrm{Trailing} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			...
			self.labels_dict["et_mt_1"] = "$m_{T}^{e} (GeV)$"
			self.labels_dict["et_mt_2"] = "$m_{T}^{#tau_{h}} (GeV)$"
			...
			self.labels_dict["em_jpt_1"] = "$\\mathrm{Leading} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			self.labels_dict["em_jpt_2"] = "$\\mathrm{Trailing} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			...
			self.labels_dict["mm_jpt_1"] = "$\\mathrm{Leading} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			self.labels_dict["mm_jpt_2"] = "$\\mathrm{Trailing} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			...
			self.labels_dict["ee_jpt_1"] = "$\\mathrm{Leading} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
			self.labels_dict["ee_jpt_2"] = "$\\mathrm{Trailing} \\mathrm{p}_{\\mathrm{T}}^{\\mathrm{jet}} (\\mathrm{GeV})$"
