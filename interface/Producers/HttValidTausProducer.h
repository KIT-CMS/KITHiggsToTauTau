...
protected:
	...
	virtual void Init(KappaSettings const& settings) override {
		...
		LambdaNtupleConsumer<HttTypes>::AddFloatQuantity("leadingTauIso", [this](HttTypes::event_type const& event, HttTypes::product_type const& product, HttTypes::setting_type) {
		...
		LambdaNtupleConsumer<HttTypes>::AddFloatQuantity("leadingTauIsoOverPt", [this](HttTypes::event_type const& event, HttTypes::product_type const& product, HttTypes::setting_type) {
		...
		LambdaNtupleConsumer<HttTypes>::AddFloatQuantity("trailingTauIso", [this](HttTypes::event_type const& event, HttTypes::product_type const& product, HttTypes::setting_type) {
		...
		LambdaNtupleConsumer<HttTypes>::AddFloatQuantity("trailingTauIsoOverPt", [this](HttTypes::event_type const& event, HttTypes::product_type const& product, HttTypes::setting_type) {
		...
		LambdaNtupleConsumer<HttTypes>::AddFloatQuantity("leadingTauEnergyAssymetry", [this](HttTypes::event_type const& event, HttTypes::product_type const& product, HttTypes::setting_type) {
