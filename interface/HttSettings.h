...
public:
	...
	IMPL_SETTING_DEFAULT(bool, UpdateMetWithBJetRegression, false);
	...
	IMPL_SETTING_FLOATLIST_DEFAULT(TauEnergyCorrectionOneProngPtDependant, {});
	...
	IMPL_SETTING_FLOATLIST_DEFAULT(TauEnergyCorrectionOneProngPtDependantShift, {});
	IMPL_SETTING_FLOATLIST_DEFAULT(TauEnergyCorrectionOneProngPiZerosPtDependantShift, {});
	IMPL_SETTING_FLOATLIST_DEFAULT(TauEnergyCorrectionThreeProngPtDependantShift, {});
	IMPL_SETTING_FLOATLIST_DEFAULT(TauEnergyCorrectionThreeProngPiZerosPtDependantShift, {});
