...
void BoostRestFrameProducer::Init(setting_type const& settings)
{
	...
	for (size_t leptonIndex = 0; leptonIndex < 2; ++leptonIndex)
	{
		...
		LambdaNtupleConsumer<HttTypes>::AddRMFLVQuantity("lep"+leptonIndexString+"LVBoostToDiLeptonSystem", [leptonIndex](event_type const& event, product_type const& product, setting_type const& settings)
		{
		...
		LambdaNtupleConsumer<HttTypes>::AddRMFLVQuantity("lep"+leptonIndexString+"LVBoostToDiTauSystem", [leptonIndex](event_type const& event, product_type const& product, setting_type const& settings)
		{
		...
		LambdaNtupleConsumer<HttTypes>::AddRMFLVQuantity("tau"+leptonIndexString+"LVBoostToDiTauSystem", [leptonIndex](event_type const& event, product_type const& product, setting_type const& settings)
		{
		...
		LambdaNtupleConsumer<HttTypes>::AddRMFLVQuantity("genMatchedTau"+leptonIndexString+"VisibleLVBoostToGenDiLeptonSystem", [leptonIndex](event_type const& event, product_type const& product, setting_type const& settings)
		{
		...
		LambdaNtupleConsumer<HttTypes>::AddRMFLVQuantity("genMatchedTau"+leptonIndexString+"LVBoostToGenDiLeptonSystem", [leptonIndex](event_type const& event, product_type const& product, setting_type const& settings)
		{
			KGenTau* genTau = SafeMap::GetWithDefault(product.m_genTauMatchedLeptons, product.m_flavourOrderedLeptons.at(leptonIndex), static_cast<KGenTau*>(nullptr));
		...
		LambdaNtupleConsumer<HttTypes>::AddRMFLVQuantity("genMatchedTau"+leptonIndexString+"LVBoostToGenDiTauSystem", [leptonIndex](event_type const& event, product_type const& product, setting_type const& settings)
		{
			KGenTau* genTau = SafeMap::GetWithDefault(product.m_genTauMatchedLeptons, product.m_flavourOrderedLeptons.at(leptonIndex), static_cast<KGenTau*>(nullptr));
