...
//		return new TauSpinnerProducer();
	...
	else if(id == DiBJetQuantitiesProducer().GetProducerId())
		return new DiBJetQuantitiesProducer();
	...
	else if(id == NewETTagAndProbePairCandidatesProducer().GetProducerId())
		return new NewETTagAndProbePairCandidatesProducer();
...
//		return new SimpleFitProducer();
	...
	else if(id == EmbeddedZpTMassCorrectionsProducer().GetProducerId())
		return new EmbeddedZpTMassCorrectionsProducer();
...
ConsumerBaseUntemplated * HttFactory::createConsumer (std::string const& id)
{
	...
	else if(id == NewETTagAndProbePairConsumer().GetConsumerId())
		return new NewETTagAndProbePairConsumer();
